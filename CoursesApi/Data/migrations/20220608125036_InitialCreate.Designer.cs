...
namespace CoursesApi.Data.migrations
{
    ...
    [Migration("20220608125036_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoursesApi.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CoursesApi.Models.StudentInCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CategoryTeacher", b =>
                {
                    b.HasOne("CoursesApi.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("CompetencesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CoursesApi.Models.Teacher", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CoursesApi.Models.Student", b =>
                {
                    b.HasOne("CoursesApi.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("CoursesApi.Models.StudentInCourse", b =>
                {
                    ...
                    b.HasOne("CoursesApi.Models.Student", "Student")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CoursesApi.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
